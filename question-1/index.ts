...
//1- let
let studentName:string="Huma Mohsin";
let id="102167";
...
//4- interface  //contains structure of data
interface student{
    name:string,
    course:string,
    duration:string,
...
function Student_Info(candidate:student){
    console.log(`Student Name : ${candidate.name}`);
    console.log(`Enrolled Course : ${candidate.course}`);
    console.log(`Course Duration : ${candidate.duration}`);
    console.log(`Enrolled In Courses : ${candidate.No_of_courses}`);

}

const obj_std:student={
    name:"HUMA Mohsin",
